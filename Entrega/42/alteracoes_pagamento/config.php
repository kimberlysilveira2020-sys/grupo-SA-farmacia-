...
class Config {
    ...
    // Configurações PIX
    const PIX_CHAVE      = 'farmavida@exemplo.com.br'; // Altere para a chave PIX real
    const PIX_NOME       = 'Farmacia Vida Saudavel';   // Nome do recebedor (max 25 chars)
    const PIX_CIDADE     = 'Joinville';                // Cidade do recebedor (max 15 chars)
    const PIX_TXID       = 'FARMAVIDA';                // Identificador da transação
