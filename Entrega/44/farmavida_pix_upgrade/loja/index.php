...
<div class="modal-overlay" id="modal-pix">
    <div class="modal-box" style="max-width:480px;">
        <div class="modal-box__header" style="background:linear-gradient(135deg,#1daa5c,#128446);color:#fff;">
            ...
            <button onclick="fecharPix()" style="color:#fff;"><i class="bi bi-x-lg"></i></button>
        </div>
...
async function checkout() {
    ...
    // Abre modal PIX e mostra loading
    fecharCarrinho();
    ...
    try {
        ...
        if (d.success) {
            ...
            document.getElementById('pix-body').innerHTML =
                `<div style="color:#c62828;padding:20px;"><i class="bi bi-exclamation-triangle-fill"></i> ${d.message}</div>`;
        }
    } catch(e) {
        document.getElementById('pix-body').innerHTML =
            `<div style="color:#c62828;padding:20px;"><i class="bi bi-exclamation-triangle-fill"></i> Erro ao gerar PIX. Tente novamente.</div>`;
    }
}
...
function renderizarPix(d) {
    ...
    body.innerHTML = `
        ...
        <div class="pix-copiacola" id="pix-cc" onclick="copiarPix(this, '${d.payload}')"
             title="Clique para copiar">${d.payload}</div>
        <button class="btn-copiar" onclick="copiarPix(document.getElementById('pix-cc'), '${d.payload}')">
        ...
        <button class="pix-ok-btn" onclick="fecharPix()">
            <i class="bi bi-check-circle"></i> Já paguei — fechar
        </button>`;
...
function fecharPix() {
    ...
    toast('🎉 Pedido realizado! Aguardamos seu pagamento PIX.');
}
