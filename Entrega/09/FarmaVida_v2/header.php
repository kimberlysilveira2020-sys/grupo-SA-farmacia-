...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= basename($_SERVER['PHP_SELF']) === 'vendas.php' ? 'active' : '' ?>" href="vendas.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= basename($_SERVER['PHP_SELF']) === 'produtos.php' ? 'active' : '' ?>" href="produtos.php">
    ...
    <div class="container mt-3">
        ...
        <div class="alert alert-<?= htmlspecialchars($flash['category']) ?> alert-dismissible fade show" role="alert">
            <?php if ($flash['category'] === 'success'): ?>
                <i class="bi bi-check-circle-fill"></i>
            <?php elseif ($flash['category'] === 'danger'): ?>
