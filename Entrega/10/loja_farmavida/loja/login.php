...
async function fazerLogin() {
  ...
  try {
    ...
    const res = await fetch('loja_api.php?endpoint=cliente_login', { method:'POST', body:fd });
...
async function fazerCadastro() {
  ...
  try {
    ...
    fd.append('senha', senha);
    const res = await fetch('loja_api.php?endpoint=cliente_registrar', { method:'POST', body:fd });
    const data = await res.json();
