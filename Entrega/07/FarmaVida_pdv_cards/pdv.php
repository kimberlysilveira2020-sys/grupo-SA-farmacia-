...
.produto-card:hover { box-shadow: 0 3px 12px rgba(25,118,210,.15); transform: translateY(-1px); }
.produto-card--promo { border-color: #e53935; border-left: 3px solid #e53935; }
...
.produto-card__info { flex: 1; min-width: 0; }
.produto-card__nome { font-size: .85rem; font-weight: 700; color: #212121; margin: 0 0 1px; line-height: 1.2; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.produto-card__fab  { font-size: .72rem; color: #9e9e9e; margin: 0 0 3px; }
.produto-card__controlado { font-size: .65rem; margin-bottom: 3px; }

.produto-card__preco-wrap { display: flex; align-items: baseline; gap: 5px; }
...
.produto-card__estoque { font-size: .7rem; margin-top: 2px; }
